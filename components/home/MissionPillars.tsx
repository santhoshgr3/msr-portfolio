      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {t.items.map((p, i) => (
            ...
            >
              <div className="h-full border border-[#E8E8E8] rounded-2xl p-6 hover:border-[#FF6F00] hover:shadow-xl transition-all duration-300 flex flex-col">
                <div className="flex items-start justify-between mb-5">
                  <span className="text-xs font-mono font-bold text-[#E8E8E8] text-3xl leading-none">{numbers[i]}</span>
